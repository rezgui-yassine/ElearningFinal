...
import { Dialog, DialogTitle, DialogContent, TextField, DialogActions, Button } from '@mui/material'; // Importez les composants nécessaires de Material-UI
...
const CoursAtachment = () => {
  ...
  const handleSend = async () => {
    try {
      const response = await axios.post(`http://localhost:3000/api/courses/add-review/${courseId}`, {
        review: review,
        userId: userId
      });
